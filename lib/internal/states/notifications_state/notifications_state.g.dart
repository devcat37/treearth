...
mixin _$NotificationsState on _NotificationsStateBase, Store {
  Computed<bool>? _$hasUnreadNotificationsComputed;

  @override
  bool get hasUnreadNotifications => (_$hasUnreadNotificationsComputed ??=
          Computed<bool>(() => super.hasUnreadNotifications,
              name: '_NotificationsStateBase.hasUnreadNotifications'))
      .value;
